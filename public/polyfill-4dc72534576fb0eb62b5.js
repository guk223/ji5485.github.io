        ...
        !(function () {
          ...
          jt(
            ...
            jt(
              ...
              {
                merge: function (t) {
                  for (var e = A(this), r = Jt(e.set), n = 0; n < arguments.length; )
          ...
          var en = function () {
            for (var t = A(this), e = Jt(t.add), r = 0, n = arguments.length; r < n; r++)
          ...
          var Dn = s.f,
            Cn = function (t) {
              return function (e) {
                for (var r, n = g(e), o = Bt(n), i = o.length, u = 0, c = []; i > u; )
                  (r = o[u++]), (a && !Dn.call(n, r)) || c.push(t ? [r, n[r]] : n[r]);
                return c;
              };
            },
            ...
            jt(
              { target: 'Object', stat: !0, sham: !a },
              {
                getOwnPropertyDescriptors: function (t) {
                  for (var e, r, n = g(t), o = x.f, i = St(n), a = {}, u = 0; i.length > u; )
                ...
                [
                  ...
                  function (t, o) {
                    ...
                    for (var h = 0, p = 0, d = []; p < u.length; ) {
                      ...
                      if (null === g || (v = ua(ct(f.lastIndex + (ca ? 0 : p)), u.length)) === h)
                        p = Zi(u, p, s);
                      else {
                ...
                stringify: function (t, e, r) {
                  ...
                  if (((n = e), (y(e) || void 0 !== t) && !Ha(t)))
                    return (
                      ee(e) ||
                        (e = function (t, e) {
                          if (('function' == typeof n && (e = n.call(this, t, e)), !Ha(e)))
                            return e;
                        }),
                      (o[1] = e),
                      Ua.apply(null, o)
                ...
                (this.bodyUsed = this.bodyUsed),
                  ...
                  t
                    ? 'string' == typeof t
                      ...
                      : Nc && jc && (e = t) && DataView.prototype.isPrototypeOf(e)
          ...
          function Vc(t, e) {
            ...
            if (
              ...
              (!e.headers && this.headers) || (this.headers = new Cc(e.headers)),
              (this.method =
          ...
          qc.redirect = function (t, e) {
            if (-1 === Hc.indexOf(e)) throw new RangeError('Invalid status code');
          ...
          function Yc(t, e) {
            return new Promise(function (r, n) {
              var o = new Vc(t, e);
              if (o.signal && o.signal.aborted) return n(new Xc('Aborted', 'AbortError'));
          ...
          (Yc.polyfill = !0),
            Ac.fetch || ((Ac.fetch = Yc), (Ac.Headers = Cc), (Ac.Request = Vc), (Ac.Response = qc)),
            (function (t) {
              var e = (function () {
                  try {
          ...
          var es = (function () {
            ...
            : function (t, e) {
                for (var r, n, o = ts(t), i = 1; i < arguments.length; i++) {
                  for (var a in (r = Object(arguments[i]))) Qc.call(r, a) && (o[a] = r[a]);
                  if (Jc) {
                    n = Jc(r);
                    for (var u = 0; u < n.length; u++) Zc.call(r, n[u]) && (o[n[u]] = r[n[u]]);
                  }
                }
                return o;
              };
...
//# sourceMappingURL=polyfill-4dc72534576fb0eb62b5.js.map
